...
function createUrl(actionName: string): string {
  return `${environment.paths.apiHost}${actionName}`;
}
...
export const appApiResources = {
  baseUrl: environment.paths.apiHost,
  staticUploadsPath: `${environment.paths.apiHost}Uploads/`,
  tikcers: createUrl('tickers'),
  news: createUrl('news'),
